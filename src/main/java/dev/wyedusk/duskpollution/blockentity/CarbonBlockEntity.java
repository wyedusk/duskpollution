...
public class CarbonBlockEntity extends BlockEntity {
    private int life = 0;
    private int skyMoves = 0;
    private final int tickOffset;

    public CarbonBlockEntity(
            BlockPos pos, BlockState state) {
        super(DPBlockEntities.CARBON_BLOCK_ENTITY.get(), pos, state);
